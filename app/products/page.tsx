...
const products = [
  ...
  { title: "QR-Bar Scanner", image: "/images/products/QRBar-240x300.png", slug: "qrbar-scanner" },
  { title: "OMS", image: "/images/products/OMS-300x300.webp", slug: "office-management-system" },
  { title: "BackOffice AI", image: "/images/products/BackOffice-300x300.webp", slug: "back-office-ai" },
  ...
  return (
    <>
      ...
      <main>
        ...
        <ServiceCta title="Explore Our Solutions!" cta="Schedule a Call" />
      </main>
      <SiteFooter />
    </>
  )
