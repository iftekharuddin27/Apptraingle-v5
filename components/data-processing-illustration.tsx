...
import "./DataProcessingIllustration.animation.css"

export default function DataProcessingIllustration({ className }: { className?: string }) {
  return (
        ...
        <g transform="translate(-332 61.473)">
          <g className="svg-anim svg-a1">
            <g transform="translate(572.559 177.193)">
              ...
              <rect width="135.336" height="3.67" transform="translate(212.446 420.078)" fill="#e6e6e6" />
              <path d="M551.9,347.661H7.545A7.553,7.553,0,0,1,0,340.117V29.456a7.553,7.553,0,0,1,7.545-7.546H551.9a7.554,7.554,0,0,1,7.545,7.545V340.117a7.554,7.554,0,0,1-7.545,7.545Z" transform="translate(0 -21.911)" fill="#e6e6e6" />
              ...
              <g className="svg-anim svg-tick">
                <path d="M2.8,0H46.042a2.8,2.8,0,0,1,2.8,2.8v8.392a2.8,2.8,0,0,1-2.8,2.8H2.8a2.8,2.8,0,0,1-2.8-2.8V2.8A2.8,2.8,0,0,1,2.8,0Z" transform="translate(63.636 238.462)" fill="#3a80ff" />
              </g>
              ...
              <g className="svg-anim svg-tick">
                <path d="M2.8,0H46.042a2.8,2.8,0,0,1,2.8,2.8v8.392a2.8,2.8,0,0,1-2.8,2.8H2.8a2.8,2.8,0,0,1-2.8-2.8V2.8A2.8,2.8,0,0,1,2.8,0Z" transform="translate(216.783 238.462)" fill="#3a80ff" />
              </g>
              ...
              <g className="svg-anim svg-tick">
                <path d="M2.8,0H46.042a2.8,2.8,0,0,1,2.8,2.8v8.392a2.8,2.8,0,0,1-2.8,2.8H2.8a2.8,2.8,0,0,1-2.8-2.8V2.8A2.8,2.8,0,0,1,2.8,0Z" transform="translate(365.734 238.462)" fill="#3a80ff" />
              </g>
            </g>
          </g>
          <g className="svg-anim svg-a2">
            <g transform="translate(332 -57.413)">
              ...
              <g className="dp-card-1" transform="translate(481.303 137.322)">
                <rect width="82" height="81" rx="6" transform="translate(-0.303 -0.322)" fill="#f2f2f2" />
                <path d="M3.4,1.7A1.7,1.7,0,0,0,1.7,3.4V77.1a1.7,1.7,0,0,0,1.7,1.7H78.233a1.7,1.7,0,0,0,1.7-1.7V3.4a1.7,1.7,0,0,0-1.7-1.7H3.4M3.4,0H78.233a3.4,3.4,0,0,1,3.4,3.4V77.1a3.4,3.4,0,0,1-3.4,3.4H3.4A3.4,3.4,0,0,1,0,77.1V3.4A3.4,3.4,0,0,1,3.4,0Z" transform="translate(0 0)" fill="#e6e6e6" />
                <g className="svg-anim svg-msg1">
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 13.606)" fill="#3a80ff" />
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 26.078)" fill="#3a80ff" />
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 38.55)" fill="#3a80ff" />
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 51.021)" fill="#3a80ff" />
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 63.493)" fill="#3a80ff" />
                </g>
              </g>
              <g className="dp-card-2" transform="translate(373.648 40.86) rotate(20)">
              ...
              <g className="dp-card-3" transform="translate(120.165 25.366)">
                ...
                <g className="svg-anim svg-msg3">
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.625 13.606)" fill="#3a80ff" />
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.625 26.078)" fill="#3a80ff" />
                  <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.625 38.55)" fill="#3a80ff" />
                </g>
              </g>
              <g className="dp-card-4" transform="matrix(0.995, 0.105, -0.105, 0.995, 245.393, -4.067)">
                ...
                <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 14.028)" fill="#3a80ff" />
                <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 26.5)" fill="#3a80ff" />
                <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 38.972)" fill="#3a80ff" />
                <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 51.444)" fill="#3a80ff" />
                <path d="M1.7,0H52.722a1.7,1.7,0,1,1,0,3.4H1.7A1.7,1.7,0,0,1,1.7,0Z" transform="translate(13.606 63.916)" fill="#3a80ff" />
              </g>
              <g className="dp-card-5" transform="translate(0 0)">
